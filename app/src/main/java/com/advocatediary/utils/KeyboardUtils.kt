...
class KeyboardUtils : ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private  var mScreenDensity: Float = 0.0f
    private  var sListenerMap = HashMap<SoftKeyboardToggleListener, KeyboardUtils>()
...
/**
    ...
    private fun KeyboardUtils(act: Activity, listener: SoftKeyboardToggleListener) {
        mCallback = listener
